      ...
      public struct Accommodation: GraphQLSelectionSet {
        ...
        public struct Node: GraphQLSelectionSet {
          ...
          public struct Property: GraphQLSelectionSet {
            ...
            public init(id: String, name: String? = nil, summary: String? = nil, latitude: Double? = nil, longitude: Double? = nil, heroMedia: HeroMedium? = nil) {
              self.init(unsafeResultMap: ["__typename": "Property", "id": id, "name": name, "summary": summary, "latitude": latitude, "longitude": longitude, "heroMedia": heroMedia.flatMap { (value: HeroMedium) -> ResultMap in value.resultMap }])
            }
